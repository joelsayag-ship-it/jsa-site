      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 md:py-24 grid md:grid-cols-2 gap-16 items-center w-full">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                JSA Expertise est un cabinet d&apos;expertise comptable 100% digital
                conçu pour les freelances et agences. On gère vos chiffres,
                vous gérez votre croissance.
              </p>
            ...
            <div className="flex justify-center md:justify-end">
              <div className="relative">
                {/* fond décoratif turquoise pâle */}
                <div className="absolute inset-0 bg-turquoise-500/15 rounded-3xl scale-105 -rotate-2" />
                <Image
                  src="/images/joel.png"
        ...
        <section className="bg-white border-y border-gray-100">
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-14 md:py-20">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-x-20">
              {/* 150+ entrepreneurs */}
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-turquoise-500 flex items-center justify-center flex-shrink-0">
                  <svg className="w-7 h-7 md:w-8 md:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <div>
                  <p className="text-2xl md:text-3xl font-extrabold text-gray-900 leading-none">150+</p>
                  <p className="text-sm md:text-base text-gray-500 mt-1.5">entrepreneurs accompagnés</p>
                </div>
              </div>
              ...
              {/* Google reviews */}
              <div className="flex items-center gap-4">
                <svg className="w-10 h-10 md:w-12 md:h-12 flex-shrink-0" viewBox="0 0 24 24">
                ...
                <div>
                  <div className="flex items-center gap-2 leading-none">
                    <span className="text-2xl md:text-3xl font-extrabold text-gray-900">5,0</span>
                  ...
                  <p className="text-sm md:text-base text-gray-500 mt-1.5">30 avis Google</p>
                </div>
              </div>
              ...
              <a
                href="https://annuaire.experts-comptables.org/expert-comptable/36207-jsa-expertise-charenton-le-pont-94220"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center transition-opacity hover:opacity-80"
                aria-label="Voir la fiche JSA Expertise sur l'annuaire de l'Ordre des Experts-Comptables"
              >
                <Image
        ...
        {/* ── 7. CONTACT ───────────────────────────────────── */}
        <ContactSection className="bg-[#F1F8EA]" />
